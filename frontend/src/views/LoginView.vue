...
const onSubmit = async () => {
  ...
  try {
    ...
    const redirectTo = typeof route.query.redirect === 'string' ? route.query.redirect : '/events'
  ...
  <section class="login-page">
    <div class="login-card panel">
      <div class="login-head">
        <h1>Sign In</h1>
        <p>Choose a hardcoded account to open the student or organizer interface.</p>
      </div>
